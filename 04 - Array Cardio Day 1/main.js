 // Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      // Array.prototype.map() : always return the same amount of items as you give it 
      ...
      const ordered = inventors.sort((a, b) => a.year > b.year ? 1 : -1); // arrow function with using ternary operator
      ...
      // var totalYears = 0;      ---------> using for loop to sum total years, but too more lines
